...
info_html += '<textarea id="paramJson" rows="10" cols="100" spellcheck="false"></textarea><button id="generateLongUrl" >JSONからURLを再生成</button><br />';
info_html += '<h2 style="margin-bottom:15px;font-size:20px">出力内容(LongURL)</h2>';
info_html += '<textarea id="longUrl" rows="6" cols="100" spellcheck="false"></textarea><button id="copyLongUrl">コピー</button><button id="openLongUrl" >オープン</button><br />';
