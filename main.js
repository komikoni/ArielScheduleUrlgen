...
var convert_params = {
    // 【基本タブ】
    title: { name: "タイトル", type: "default" },
    label: { name: "ラベル", type: "checked", array: true },
    color: { name: "背景色", type: "default" },
    is_all_day: { name: "終日", type: "checked" },
    dtstart: { name: "開始", type: "ymdhm" },
    dtend: { name: "終了", type: "ymdhm" },
    attendee: { name: "出席者", type: "resid", array: true },
    facility: { name: "施設", type: "resid", array: true },
    // 【詳細タブ】
    organizer: { name: "開催者", type: "resid" },
    body_format: { name: "本文・文字修飾", type: "?" },
    body: { name: "本文", type: "?" },
    location: { name: "場所", type: "default" },
    address: { name: "住所", type: "default" },
    // 【システムタブ】
    banner: { name: "予定の種別", type: "checked" },
    scope: { name: "公開範囲", type: "default" },
    additional_public: { name: "その他の公開範囲", type: "resid", array: true },
    allow_attendee_edit: { name: "編集許可", type: "default" },
    view_presence_on_news: { name: "出欠と予約状況", type: "default" },
    delegate_allowed: { name: "代理出席", type: "default" },
    // 【繰り返しタブ】
    recurrent_type: { name: "パターン", type: "checked" },
    recurrent_interval: { name: "日・週・月・年毎", type: "default" },
    days_of_week: { name: "週毎の曜日", type: "checked", array: true },
    month_of_year: { name: "年毎の月", type: "default" },
    recurrent_subtype: { name: "月・年毎の特定日・週", type: "checked" },
    day_of_month: { name: "月・年毎の特定日", type: "default" },
    week_of_month: { name: "月・年毎の特定週", type: "default" },
    day_of_week: { name: "月・年毎の特定週の曜日", type: "default" },
    is_all_day_recurrent: { name: "終日", type: "checked" },
    irregular_dates: { name: "不定期日付", type: "ymd", array: true },
    dtstart_recurrent: { name: "開始時刻", type: "hm", out_key: "dtstart" },
    dtend_recurrent: { name: "終了時刻", type: "hm", out_key: "dtend" },
    recurrent_start: { name: "開始日", type: "default" },
    limit_type: { name: "期限", type: "checked" },
    limit_count: { name: "反復回数", type: "default" },
    limit_date: { name: "終了日", type: "ymd" },
    recurrent_except_rule: { name: "特例日の扱い", type: "default" },
    recurrent_except_target: { name: "特例日", type: "checked", array: true },
    // 【その他タブ】
    radio_reflection: { name: "来館者の申請", type: "checked" },
    visitor_company: { name: "来館者１会社名", type: "default" },
    visitor_post: { name: "来館者１役職", type: "default" },
    visitor_name: { name: "来館者１氏名", type: "default" },
    visitor_company2: { name: "来館者２会社名", type: "default" },
    visitor_post2: { name: "来館者２役職", type: "default" },
    visitor_name2: { name: "来館者２氏名", type: "default" },
    visitor_company3: { name: "来館者３会社名", type: "default" },
    visitor_post3: { name: "来館者３役職", type: "default" },
    visitor_name3: { name: "来館者３氏名", type: "default" },
    visitor_company4: { name: "来館者４会社名", type: "default" },
    visitor_post4: { name: "来館者４役職", type: "default" },
    visitor_name4: { name: "来館者４氏名", type: "default" },
    numeric_field: { name: "来館人数", type: "default" },
    wireless_select: { name: "無線LAN利用", type: "default" },
    group_field: { name: "面会者部門名", type: "resid" },
    tel_dept: { name: "面会者部門内線番号", type: "default" },
    user_visitor: { name: "面会者氏名", type: "resid" },
    tel_extension: { name: "面会者内線番号", type: "default" },
    group_field_2: { name: "代替者１部門名", type: "resid" },
    tel_dept_2: { name: "代替者１部門内線番号", type: "default" },
    user_visitor_2: { name: "代替者１氏名", type: "resid" },
    tel_extension_2: { name: "代替者１内線番号", type: "default" },
    group_field_3: { name: "代替者２部門名", type: "resid" },
    tel_dept_3: { name: "代替者２部門内線番号", type: "default" },
    user_visitor_3: { name: "代替者２氏名", type: "resid" },
    tel_extension_3: { name: "代替者２部門内線番号", type: "default" },
    text_field: { name: "受付の伝言", type: "default" },
};
